/*! layer-v3.0.3 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */
 ...
 function layeropen(msg,url){
	var lo1 = layer.open({
        ...
        title: '系统提示',
        closeBtn: 0,
        area: ['7.586667rem', 'auto'],
        shadeClose: false,
        content: '<div class="ui-layer f-tac mb30 f15">'+
					'<div>'+msg+'</div>'+
				 '</div>',
        btn: ['确定','取消'],
...
function layertitleopen(msg,title,url){
	var lo1 = layer.open({
		type: 1,
        title: '系统提示',
        closeBtn: 0,
...
function layerOpenNew(msg,url,t){
	...
	var lo1 = layer.open({
        ...
        area: ['7.586667rem', 'auto'],
        shadeClose: true,
		content: '<div class="ui-layer f-tac f15">'+
					'<div style="line-height: 50px;">'+msg+'</div>'+
				 '</div>',
		time:t,
        btn: false,
        end: function(){
...
function layercontent(msg){
	return layer.open({
        ...
        area: ['7.586667rem', 'auto'],
        content: '<div class="ui-layer f-tac f15">'+
					'<div class="pt20 pb20">'+msg+'</div>'+
				 '</div>',
	});
	
}

function layerjump(content){
	var lo2 = layer.open({
        type: 1,
        title: false,
        closeBtn: 0,
...
function layerwarn(msg,t){
	...
	var lo3 = layer.open({
        ...
        btn: false,
        content: '<div class="ui-layer f-tac f15">'+
					'<div style="line-height: 20px;">'+msg+'</div>'+
				 '</div>',
	});
...
function layershiming(msg,url){
	var lo1=layer.confirm('<div class="f-tac " style="margin-top:0.5rem; line-height:0.5rem"><font style="font-size:0.45rem;">'+msg+'</font></div>', {
		  btn: ['取消','认证'], //按钮
	 	type: 0,
        title: false,
        closeBtn: 0,
        area: ['8.466667rem', 'auto'],
/* 	        area: ['6.466667rem', '4.0rem'],
*/	        shadeClose: true,	
	}, function(){
			layer.closeAll();
		}, function(){
...
function layersetpassword(msg,url){
	var lo1=layer.confirm('<div class="f-tac " style="margin-top:0.5rem; line-height:0.5rem"><font style="font-size:0.45rem;">'+msg+'</font></div>', {
		  btn: ['取消','设置'], //按钮
	 	type: 0,
        title: false,
